...
<head>
 ...
 ================================================== -->
  <meta charset="utf-8" />
  <title>XboxLeaders - License</title>
...
<div class="jumbotron jumbotron-ad hidden-print">
  <div class="container">
    ...
    <p>The full details of how XboxLeaders API is licensed</p>
  </div>
</div>
...
<div>
  <div class="alert alert-info">
    <ul class="icons-ul margin-bottom-none">
      <li>
        <i class="icon-li icon-info-sign icon-large"></i>Attribution is not required, but is much appreciated:
...
<section>
  ...
  <ul>
    <li>
      Applies to all code located in the following directories:
...
<section>
  ...
  <ul>
    <li>Applies to all XboxLeaders project files that are not a part of the Code licenses.</li>
